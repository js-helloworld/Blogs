...
<span class="line"><span>&lt;/script&gt;</span></span></code></pre></div><ol start="3"><li>ts更好地配合</li></ol><h2 id="_3-深拷贝和浅拷贝的区别是什么" tabindex="-1">3.深拷贝和浅拷贝的区别是什么? <a class="header-anchor" href="#_3-深拷贝和浅拷贝的区别是什么" aria-label="Permalink to &quot;3.深拷贝和浅拷贝的区别是什么?&quot;">​</a></h2><p>浅拷贝（Shallow Copy） 基本数据类型：赋值，赋值之后两个变量互不影响</p><p>引用数据类型：赋址，两个变量具有相同的引用，指向同一个对象，互相影响 JSON.parse(JSON.stringify(object))</p><ul><li>会忽略 undefined</li><li>会忽略symbol</li><li>不能序列化函数</li><li>不能解决循环引用的对象</li><li>不能正确处理new Date()</li><li>不能处理正则 undefined、symbol和函数这三种情况会直接被忽略。</li></ul><p>lodash这个库了，lodash提供了cloneDeep()方法，允许我们对引用类型的值进行深拷贝</p><p>简单实现</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>function deepCopy（obj） {</span></span>
